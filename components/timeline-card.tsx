        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-[1.3fr_0.9fr]">
          <div className="space-y-4">
            ...
            <div className="h-[3.85rem]">
              <div className="translate-y-2 flex h-full items-center justify-between rounded-[1rem] border border-slate-200/70 bg-white/90 px-4 py-3 opacity-0 shadow-sm backdrop-blur-sm transition-all duration-300 ease-out group-hover:translate-y-0 group-hover:opacity-100">
